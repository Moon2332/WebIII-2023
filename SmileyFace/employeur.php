        ...
        if ( $_SESSION["connexion"] == true)
        {
            ...
            if($_SERVER["REQUEST_METHOD"] != "POST"){  
                echo "  <div class=\"container-fluid\" style=\"display: flex;justify-content: space-evenly;\"> 
                            <div class=\"row\">
                                <div class=\"col-6\"> 
                                    <button type=\"button\" class=\"btn btn-link btn-outline-info btn-lg retour\" ><a href='nip.php?action=retour'> Retour </a></button>
                                </div>
                                <div class=\"col-6\"> 
                                    <button type=\"button\" class=\"btn btn-link btn-outline-info btn-lg\"> <a href='nip.php?action=decon' > Déconnexion </a></button>
                                </div>
                            </div>
                        </div>
                    ";
                        ...
                        <div class="col-12 text-center align-items-center">
                            <div class="row">
                                ...
                                <button type="button" name="Choix" class="col-4" id="Good" style="background-color: inherit; border: none;">
                                    <a href="employeur.php?id=<?php echo $id ?>&action=satis_Em">
                                        <div>
                                            <p>Satisfait</p>
                                ...
                                <a href="employeur.php?id=<?php echo $id ?>&action=neutre_Em">
                                        <div>
                                            <p>Neutre</p>
                                ...
                                <button type="button" name="Choix" class="col-4" id="Bad" style="background-color: inherit; border: none;">
                                    <a href="employeur.php?id=<?php echo $id ?>&action=insatis_Em">
                                        <div>
                                            <p>Insatisfait</p>
