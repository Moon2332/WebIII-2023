...
?>
                                    ...
                                    <td> <a href="index.php?id=<?php echo $row["id"] ?>" > Vote Élève </a></td>
                                    <td> <a href="employeur.php?id=<?php echo $row["id"] ?>" > Vote Employeur </a></td>
                                    <td> <a href="stats.php?id=<?php echo $row["id"] ?>" > Statistiques </a></td>
                                    <td> <a href="modEven.php?id=<?php echo $row["id"] ?>" > Modifier </a></td>
                                    <td> <a href="supEven.php?id=<?php echo $row["id"] ?>" > Supprimer </a></td>
                                </tr>      
<?php                  
        }
?>
                    ...
                    <div class="row buttonAdmin">
                        <button type="button" class="btn btn-link btn-outline-primary btn-lg"> <a href='ajouterEve.php' > Ajouter </a></button>
