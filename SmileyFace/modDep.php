...
<body>
        ...
        if ( $_SESSION["connexion"] == true)
        {
            ...
            if ($_SESSION["action"] == 'PageDep')
            {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE departement SET id_D = '$id_D', nom = '$nom', coordonateur='$coor' WHERE id = '$id' ";
    ...
    ?>
                    <div class="container-fluid" id="FormAjouterCom">
                        <div class="row titre">
                            <h1> Formulaire pour modifier un Departement </h1>
                        </div>
                                ...
                                <div class="container-fluid allofem">
                                    <div class="row">
                                        ...
                                        <div class="All col-12">
                                            ...
                                            <button type="button" class="btn btn-link btn-outline-primary btn-lg retour" ><a href='dep.php?action=PageDep'> Retour </a></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
